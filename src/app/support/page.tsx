...
export default function SupportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // TODO: Call API to submit support ticket
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-6 py-8">
      {/* Header - Outside and above the grid */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          แจ้งปัญหาการใช้งาน
        </h1>
        <p className="text-sm text-gray-600">
          กรอกข้อมูลด้านล่างเพื่อแจ้งปัญหาที่พบ
        </p>
      </div>

      {/* Grid Layout: 70% left, 30% right on desktop */}
      <div className="grid grid-cols-1 lg:grid-cols-[70%_30%] gap-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                กรุณาอธิบายปัญหาอย่างละเอียด เพื่อให้ทีมงานสามารถช่วยเหลือได้อย่างรวดเร็ว
              </p>
            </div>
            ...
            {/* Action Buttons - Left: Clear, Right: Submit */}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-50 border border-yellow-100 rounded-xl p-6 shadow-sm">
            ...
            <p className="text-sm text-yellow-700 leading-relaxed break-all">
              support.eldernursing.gmail.com
            </p>
          </div>
        </div>
      </div>
